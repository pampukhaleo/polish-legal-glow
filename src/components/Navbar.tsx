        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <Link to="/polish-legal-glow/" className="text-white font-serif text-xl font-bold hover:text-gray-300 transition-colors">
                Геннадій Пампуха
              </Link>
            </div>
          </div>
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4">
              <Link to="/polish-legal-glow/about" className="text-gray-300 hover:text-white px-3 py-2 text-sm font-medium">
                Про мене
              </Link>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-zinc-900">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link to="/polish-legal-glow/about" className="text-gray-300 hover:text-white block px-3 py-2 text-base font-medium">
              Про мене
            </Link>
