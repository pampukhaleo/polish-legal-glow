        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
            <div className="lg:col-span-2 space-y-6">
              <div className="bg-[#1F1F3A] border border-[#1E40AF] rounded-lg p-6 shadow-md">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="text-sm text-[#60A5FA]">Email</p>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="text-sm text-[#60A5FA]">Телефон</p>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="text-sm text-[#60A5FA]">Адреса офісу</p>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="text-sm text-[#60A5FA]">Години роботи</p>
            ...
            <div className="lg:col-span-3 bg-[#1F1F3A] border border-[#1E40AF] rounded-lg p-6 shadow-md">
              <h3 className="text-xl font-serif text-white mb-6">Надіслати повідомлення</h3>
              
              <form className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="name" className="block text-sm text-[#60A5FA] mb-1">Повне ім'я</label>
                    <Input 
                      id="name"
                      placeholder="Ваше ім'я"
                      className="bg-[#0F1729] border-[#1E40AF] text-white focus:border-[#60A5FA]"
                    />
                  </div>
                  <div>
                    <label htmlFor="email" className="block text-sm text-[#60A5FA] mb-1">Email адреса</label>
                    <Input 
                      id="email"
                      type="email"
                ...
                <div>
                  <label htmlFor="subject" className="block text-sm text-[#60A5FA] mb-1">Тема</label>
                  <Input 
                    id="subject"
                ...
                <div>
                  <label htmlFor="message" className="block text-sm text-[#60A5FA] mb-1">Повідомлення</label>
                  <Textarea 
                    id="message"
                    placeholder="Ваше повідомлення..."
                    rows={5}
                    className="bg-[#0F1729] border-[#1E40AF] text-white resize-none focus:border-[#60A5FA]"
                  />
                </div>
